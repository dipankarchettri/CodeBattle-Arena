...
`client/         # React frontend application (Vite, Shadcn) <br>
server/         # Express.js backend API (Node.js, Drizzle)  <br>
shared/         # Shared code, primarily the Drizzle database schema <br>
.env            # Local environment secrets (DO NOT COMMIT)  <br>
